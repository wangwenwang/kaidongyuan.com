$(function(){
	...
	$("header").append('<div class="header_top"><div class="header_top_content"><div class="_top_content_left"><a href="http://120.25.76.52/general/login/index.php"  target="_blank">凯东源OA管理系统</a></div><div class="_top_content_right"><a href="javascript:;">APP下载<img src="images/header/QrCode_app.png"></a><a href="join_us.html">诚聘英才</a></div></div></div><div class="header_bottom"><div class="logo"><a href="index.html"><img src="images/header/logo.png"></a></div><div class="m_head_nav"><img src="images/i-menu-normal.png"></div><div class="m_head_navMeng"><div><span><a href="index.html">首页</a></span></div><div><span><a href="introduction.html">走进凯东源</a></span></div><div><span><a href="WarehousingService.html">产品服务</a></span></div><div><span><a href="merchants_to_join.html">加盟合作</a></span></div><div><span><a href="companyNews.html">新闻资讯</a></span></div><div><span><a href="successful_case.html">成功案例</a></span></div><div><span><a href="contactUs.html">联系我们</a></span></div></div><ul><li><a class="header_high" href="index.html">首页</a></li><li><a  class="header_high_introduction" href="introduction.html">走进凯东源</a><ul><li><a href="introduction.html">公司介绍</a></li><li><a href="history.html">发展历程</a></li><li><a href="culture.html">企业文化</a></li><li><a href="honor.html">公司荣誉</a></li><li><a href="staff.html">员工风采</a></li></ul></li><li><a  class="header_high_TPL" href="WarehousingService.html">产品服务</a><ul><li><a href="WarehousingService.html">仓储服务</a></li><li><a href="DistributionService.html">配送服务</a></li><li><a href="WarehouseIntegration.html">仓配一体</a></li><li><a href="Value-added_logistics_service.html">增值服务</a></li><li><a href="CirculationService.html">流通服务</a></li><li><a href="system_service.html">系统服务</a></li><li><a href="consultation_service.html">物流咨询服务</a></li></ul></li><li><a  class="header_high" href="merchants_to_join.html">加盟合作</a></li><li><a  class="header_high_companyNews" href="companyNews.html">新闻资讯</a><ul><li><a href="companyNews.html">公司新闻</a></li><li><a href="industryNews.html">行业新闻</a></li></ul></li><li><a  class="header_high" href="successful_case.html">成功案例</a></li><li><a  class="header_high_contactUs" href="contactUs.html">联系我们</a><ul><li><a href="contactUs.html">公司总部</a></li><li><a href="BranchOffice.html">子公司及办事处</a></li><li><a href="WarehouseAddress.html">仓库地址</a></li></ul></li></ul></div>');
	...
	$('header .header_bottom .m_head_nav').click(function(){
		...
		if($('header .header_bottom .m_head_navMeng').css('display') == 'none'){
			...
			$(".m_head_nav img").attr('src','images/i-menu-click.png');
			...
			$(".m_head_nav img").attr('src','images/i-menu-normal.png');
